...
var valueNumber = 2;
var valueString = "abc";
var valueArray = [1, 3, 2];
var valueObject = <{ [index: string]: number; }>{ a: 1, b: 3, c: 2};
...
/* _(..) */
var chainImplicitBoolean = <_.LoDashImplicitWrapper<boolean>>_(valueBoolean);
var chainImplicitNumber = <_.LoDashImplicitWrapper<number>>_(valueNumber);
var chainImplicitString = <_.LoDashImplicitWrapper<string>>_(valueString);
var chainImplicitArray = <_.LoDashImplicitArrayWrapper<number>>_(valueArray);
var chainImplicitObject = <_.LoDashImplicitObjectWrapper<_.Dictionary<number>>>_(valueObject);

/* _.chain */
var chainExplicitBoolean = <_.LoDashExplicitWrapper<boolean>>_.chain(valueBoolean);
var chainExplicitNumber = <_.LoDashExplicitWrapper<number>>_.chain(valueNumber);
var chainExplicitString = <_.LoDashExplicitWrapper<string>>_.chain(valueString);
var chainExplicitArray = <_.LoDashExplicitArrayWrapper<number>>_.chain(valueArray);
var chainExplicitObject = <_.LoDashExplicitObjectWrapper<_.Dictionary<number>>>_.chain(valueObject);

result = <_.LoDashExplicitWrapper<boolean>>chainImplicitBoolean.chain();
result = <_.LoDashExplicitWrapper<number>>chainImplicitNumber.chain();
result = <_.LoDashExplicitWrapper<string>>chainImplicitString.chain();
result = <_.LoDashExplicitArrayWrapper<number>>chainImplicitArray.chain();
result = <_.LoDashExplicitObjectWrapper<_.Dictionary<number>>>chainImplicitObject.chain();

/* _.tap */
result = <string>_.tap(valueString, function (array:string) { console.log(array); });
result = <number[]>_.tap(valueArray, function (array:number[]) { console.log(array); });
result = <_.LoDashImplicitWrapper<string>>chainImplicitString.tap(function (array:string) { console.log(array); });
result = <_.LoDashExplicitWrapper<string>>chainExplicitString.tap(function (array:string) { console.log(array); });
result = <_.LoDashImplicitArrayWrapper<number>>chainImplicitArray.tap(function (array:number[]) { console.log(array); });
result = <_.LoDashExplicitArrayWrapper<number>>chainExplicitArray.tap(function (array:number[]) { console.log(array); });
result = <_.LoDashImplicitObjectWrapper<_.Dictionary<number>>>chainImplicitObject.tap(function (array:_.Dictionary<number>) { console.log(array); });
result = <_.LoDashExplicitObjectWrapper<_.Dictionary<number>>>chainExplicitObject.tap(function (array:_.Dictionary<number>) { console.log(array); });

/* _(...).toString */
result = <string>chainImplicitString.toString();
result = <string>chainImplicitArray.toString();
result = <string>chainImplicitObject.toString();
result = <string>chainExplicitString.toString();
result = <string>chainExplicitArray.toString();
result = <string>chainExplicitObject.toString();

/* _(...).valueOf */
result = <string>chainImplicitString.valueOf();
result = <number[]>chainImplicitArray.valueOf();
result = <_.Dictionary<number>>chainImplicitObject.valueOf();
result = <string>chainExplicitString.valueOf();
result = <number[]>chainExplicitArray.valueOf();
result = <_.Dictionary<number>>chainExplicitObject.valueOf();

/* _(...).value */
result = <string>chainImplicitString.value();
result = <number[]>chainImplicitArray.value();
result = <_.Dictionary<number>>chainImplicitObject.value();
result = <string>chainExplicitString.value();
result = <number[]>chainExplicitArray.value();
result = <_.Dictionary<number>>chainExplicitObject.value();
...
result = <_.LoDashImplicitArrayWrapper<number>>chainImplicitArray.concat(5, 6);
result = <_.LoDashExplicitArrayWrapper<number>>chainExplicitArray.concat(5, 6);

result = <string>chainImplicitArray.join(',');
result = <_.LoDashExplicitWrapper<string>>chainExplicitArray.join(',');

result = <number>chainImplicitArray.pop();
result = <_.LoDashExplicitWrapper<number>>chainExplicitArray.pop();

result = <_.LoDashImplicitArrayWrapper<number>>chainImplicitArray.push(5, 6, 7);
result = <_.LoDashExplicitArrayWrapper<number>>chainExplicitArray.push(5, 6, 7);

result = <_.LoDashImplicitArrayWrapper<number>>chainImplicitArray.reverse();
result = <_.LoDashExplicitArrayWrapper<number>>chainExplicitArray.reverse();

result = <number>chainImplicitArray.shift();
result = <_.LoDashExplicitWrapper<number>>chainExplicitArray.shift();

result = <_.LoDashImplicitArrayWrapper<number>>chainImplicitArray.slice(1, 2);
result = <_.LoDashExplicitArrayWrapper<number>>chainExplicitArray.slice(1, 2);

result = <_.LoDashImplicitArrayWrapper<number>>chainImplicitArray.slice(2);
result = <_.LoDashExplicitArrayWrapper<number>>chainExplicitArray.slice(2);

result = <_.LoDashImplicitArrayWrapper<number>>chainImplicitArray.sort((a, b) => 1);
result = <_.LoDashExplicitArrayWrapper<number>>chainExplicitArray.sort((a, b) => 1);

result = <_.LoDashImplicitArrayWrapper<number>>chainImplicitArray.splice(1);
result = <_.LoDashExplicitArrayWrapper<number>>chainExplicitArray.splice(1);

result = <_.LoDashImplicitArrayWrapper<number>>chainImplicitArray.splice(1, 2, 5, 6);
result = <_.LoDashExplicitArrayWrapper<number>>chainExplicitArray.splice(1, 2, 5, 6);

result = <_.LoDashImplicitArrayWrapper<number>>chainImplicitArray.unshift(5, 6);
result = <_.LoDashExplicitArrayWrapper<number>>chainExplicitArray.unshift(5, 6);
...
result = <number[]>_.compact(valueArray);
result = <any[]>_.compact([0, 1, false, 2, '', 3]);

result = <_.LoDashImplicitArrayWrapper<number>>chainImplicitArray.compact();
result = <_.LoDashImplicitArrayWrapper<any>>_([0, 1, false, 2, '', 3]).compact();

result = <_.LoDashExplicitArrayWrapper<number>>chainExplicitArray.compact();
result = <_.LoDashExplicitArrayWrapper<any>>_.chain([0, 1, false, 2, '', 3]).compact();

/* _.difference */
result = <number[]>_.difference(valueArray, [5, 2, 10]);

result = <_.LoDashImplicitArrayWrapper<number>>chainImplicitArray.difference([5, 2, 10]);

result = <_.LoDashExplicitArrayWrapper<number>>chainExplicitArray.difference([5, 2, 10]);

/* _.findIndex */
result = <number>_.findIndex(['apple', 'banana', 'beet'], function (f) { return /^b/.test(f); });
result = <number>_.findIndex(['apple', 'banana', 'beet'], 'apple');
result = <number>_.findIndex([{ food: 'apple' }, { food: 'banana' }, { food: 'beet' }], { food: 'apple' });

result = <number>_(['apple', 'banana', 'beet']).findIndex(function (f:string) { return /^b/.test(f); });
result = <number>_(['apple', 'banana', 'beet']).findIndex('apple');
result = <number>_([{ food: 'apple' }, { food: 'banana' }, { food: 'beet' }]).findIndex({ food: 'apple' });

result = <_.LoDashExplicitWrapper<number>>_.chain(['apple', 'banana', 'beet']).findIndex(function (f:string) { return /^b/.test(f); });
result = <_.LoDashExplicitWrapper<number>>_.chain(['apple', 'banana', 'beet']).findIndex('apple');
result = <_.LoDashExplicitWrapper<number>>_.chain([{ food: 'apple' }, { food: 'banana' }, { food: 'beet' }]).findIndex({ food: 'apple' });

/* _.findLastIndex */
result = <number>_.findLastIndex(['apple', 'banana', 'beet'], function (f: string) { return /^b/.test(f); });
...
result = <number>_(['apple', 'banana', 'beet']).findLastIndex(function (f:string) { return /^b/.test(f); });
result = <number>_(['apple', 'banana', 'beet']).findLastIndex('apple');
result = <number>_([{ food: 'apple' }, { food: 'banana' }, { food: 'beet' }]).findLastIndex({ food: 'apple' });

result = <_.LoDashExplicitWrapper<number>>_.chain(['apple', 'banana', 'beet']).findLastIndex(function (f:string) { return /^b/.test(f); });
result = <_.LoDashExplicitWrapper<number>>_.chain(['apple', 'banana', 'beet']).findLastIndex('apple');
result = <_.LoDashExplicitWrapper<number>>_.chain([{ food: 'apple' }, { food: 'banana' }, { food: 'beet' }]).findLastIndex({ food: 'apple' });

/* _.first */
result = <number>_.first([1, 2, 3]);
result = <number[]>_.first([1, 2, 3], 2);
result = <number[]>_.first([1, 2, 3], function (num) { return num < 3; });
result = <IFoodOrganic[]>_.first(foodsOrganic, 'organic');
result = <IFoodType[]>_.first(foodsType, { 'type': 'fruit' });

result = <number>_([1, 2, 3]).first();
result = <_.LoDashImplicitArrayWrapper<number>>_([1, 2, 3]).first(2);
result = <_.LoDashImplicitArrayWrapper<number>>_([1, 2, 3]).first(function (num) { return num < 3; });
result = <IFoodOrganic>_(foodsOrganic).first();
result = <_.LoDashImplicitArrayWrapper<IFoodOrganic>>_(foodsOrganic).first('organic');
result = <_.LoDashImplicitArrayWrapper<IFoodType>>_(foodsType).first({ 'type': 'fruit' });

result = <_.LoDashExplicitWrapper<IFoodOrganic>>_.chain(foodsOrganic).first();
result = <_.LoDashExplicitArrayWrapper<IFoodOrganic>>_.chain(foodsOrganic).first('organic');
result = <_.LoDashExplicitArrayWrapper<IFoodType>>_.chain(foodsType).first({ 'type': 'fruit' });

result = <number>_.head([1, 2, 3]);
result = <number[]>_.head([1, 2, 3], 2);
result = <number[]>_.head([1, 2, 3], function (num) { return num < 3; });
result = <IFoodOrganic[]>_.head(foodsOrganic, 'organic');
result = <IFoodType[]>_.head(foodsType, { 'type': 'fruit' });

result = <number>_([1, 2, 3]).head();
result = <_.LoDashImplicitArrayWrapper<number>>_([1, 2, 3]).head(2);
result = <_.LoDashImplicitArrayWrapper<number>>_([1, 2, 3]).head(function (num) { return num < 3; });
result = <IFoodOrganic>_(foodsOrganic).head();
result = <_.LoDashImplicitArrayWrapper<IFoodOrganic>>_(foodsOrganic).head('organic');
result = <_.LoDashImplicitArrayWrapper<IFoodType>>_(foodsType).head({ 'type': 'fruit' });

result = <_.LoDashExplicitWrapper<IFoodOrganic>>_.chain(foodsOrganic).head();
result = <_.LoDashExplicitArrayWrapper<IFoodOrganic>>_.chain(foodsOrganic).head('organic');
result = <_.LoDashExplicitArrayWrapper<IFoodType>>_.chain(foodsType).head({ 'type': 'fruit' });

result = <number>_.take([1, 2, 3]);
result = <number[]>_.take([1, 2, 3], 2);
result = <number[]>_.take([1, 2, 3], function (num) { return num < 3; });
result = <IFoodOrganic[]>_.take(foodsOrganic, 'organic');
result = <IFoodType[]>_.take(foodsType, { 'type': 'fruit' });

result = <number>_([1, 2, 3]).take();
result = <_.LoDashImplicitArrayWrapper<number>>_([1, 2, 3]).take(2);
result = <_.LoDashImplicitArrayWrapper<number>>_([1, 2, 3]).take(function (num) { return num < 3; });
result = <_.LoDashImplicitArrayWrapper<IFoodOrganic>>_(foodsOrganic).take('organic');
result = <_.LoDashImplicitArrayWrapper<IFoodType>>_(foodsType).take({ 'type': 'fruit' });

result = <_.LoDashExplicitArrayWrapper<IFoodOrganic>>_.chain(foodsOrganic).take('organic');
result = <_.LoDashExplicitArrayWrapper<IFoodType>>_.chain(foodsType).take({ 'type': 'fruit' });
...
result = <_.LoDashImplicitArrayWrapper<number>>_([1, [2], [3, [[4]]]]).flatten();
result = <_.LoDashImplicitArrayWrapper<number>>_([1, [2], [3, [[4]]]]).flatten(true);
result = <_.LoDashImplicitArrayWrapper<string>>_(stoogesQuotes).flatten('quotes');

result = <_.LoDashExplicitArrayWrapper<number>>_.chain([1, [2], [3, [[4]]]]).flatten();
result = <_.LoDashExplicitArrayWrapper<number>>_.chain([1, [2], [3, [[4]]]]).flatten(true);
result = <_.LoDashExplicitArrayWrapper<string>>_.chain(stoogesQuotes).flatten('quotes');
...
result = <number>_([1, 2, 3, 1, 2, 3]).indexOf(2);
result = <number>_([1, 2, 3, 1, 2, 3]).indexOf(2, 3);
result = <number>_([1, 2, 3, 1, 2, 3]).indexOf(2, true);

result = <_.LoDashExplicitWrapper<number>>_.chain([1, 2, 3, 1, 2, 3]).indexOf(2);
result = <_.LoDashExplicitWrapper<number>>_.chain([1, 2, 3, 1, 2, 3]).indexOf(2, 3);
result = <_.LoDashExplicitWrapper<number>>_.chain([1, 2, 3, 1, 2, 3]).indexOf(2, true);

/* _.initial */

result = <number[]>_.initial([1, 2, 3]);
result = <number[]>_.initial([1, 2, 3], 2);
result = <number[]>_.initial([1, 2, 3], function (num) { return num > 1; });
result = <IFoodOrganic[]>_.initial(foodsOrganic, 'organic');
result = <IFoodType[]>_.initial(foodsType, { 'type': 'vegetable' });

result = <_.LoDashImplicitArrayWrapper<number>>_([1, 2, 3]).initial();
result = <_.LoDashImplicitArrayWrapper<number>>_([1, 2, 3]).initial(2);
result = <_.LoDashImplicitArrayWrapper<number>>_([1, 2, 3]).initial(function (num) { return num > 1; });
result = <_.LoDashImplicitArrayWrapper<IFoodOrganic>>_(foodsOrganic).initial('organic');
result = <_.LoDashImplicitArrayWrapper<IFoodType>>_(foodsType).initial({ 'type': 'vegetable' });

result = <_.LoDashExplicitArrayWrapper<number>>_.chain([1, 2, 3]).initial();
result = <_.LoDashExplicitArrayWrapper<number>>_.chain([1, 2, 3]).initial(2);
result = <_.LoDashExplicitArrayWrapper<number>>_.chain([1, 2, 3]).initial(function (num) { return num > 1; });
result = <_.LoDashExplicitArrayWrapper<IFoodOrganic>>_.chain(foodsOrganic).initial('organic');
result = <_.LoDashExplicitArrayWrapper<IFoodType>>_.chain(foodsType).initial({ 'type': 'vegetable' });

/* _.intersection */

result = <number[]>_.intersection([1, 2, 3], [101, 2, 1, 10], [2, 1]);

result = <_.LoDashImplicitArrayWrapper<number>>_([1, 2, 3]).intersection([101, 2, 1, 10], [2, 1]);

result = <_.LoDashExplicitArrayWrapper<number>>_.chain([1, 2, 3]).intersection([101, 2, 1, 10], [2, 1]);

/* _.last */

result = <number>_.last([1, 2, 3]);
result = <number[]>_.last([1, 2, 3], 2);
result = <number[]>_.last([1, 2, 3], function (num) { return num > 1; });
...
result = <_.LoDashImplicitArrayWrapper<number>>_([1, 2, 3]).last(2);
result = <_.LoDashImplicitArrayWrapper<number>>_([1, 2, 3]).last(function (num) { return num > 1; });
result = <_.LoDashImplicitArrayWrapper<IFoodOrganic>>_(foodsOrganic).last( 'organic');
result = <_.LoDashImplicitArrayWrapper<IFoodType>>_(foodsType).last({ 'type': 'vegetable' });

result = <_.LoDashExplicitWrapper<number>>_.chain([1, 2, 3]).last();
result = <_.LoDashExplicitArrayWrapper<number>>_.chain([1, 2, 3]).last(2);
result = <_.LoDashExplicitArrayWrapper<number>>_.chain([1, 2, 3]).last(function (num) { return num > 1; });
result = <_.LoDashExplicitArrayWrapper<IFoodOrganic>>_.chain(foodsOrganic).last( 'organic');
result = <_.LoDashExplicitArrayWrapper<IFoodType>>_.chain(foodsType).last({ 'type': 'vegetable' });
...
result = <number>_([1, 2, 3, 1, 2, 3]).lastIndexOf(2);
result = <number>_([1, 2, 3, 1, 2, 3]).lastIndexOf(2, 3);

result = <_.LoDashExplicitWrapper<number>>_.chain([1, 2, 3, 1, 2, 3]).lastIndexOf(2);
result = <_.LoDashExplicitWrapper<number>>_.chain([1, 2, 3, 1, 2, 3]).lastIndexOf(2, 3);
...
result = <_.LoDashImplicitArrayWrapper<number>>_([1, 2, 3, 4, 5]).xor([5, 2, 10]);
result = <_.LoDashImplicitArrayWrapper<number>>_([1, 2, 3, 4, 5]).xor([5, 2, 10], [4, 5, 6]);
...
result = <_.LoDashExplicitWrapper<number>>_([4, 2, 8, 6]).max();
result = <_.LoDashExplicitWrapper<IStoogesAge>>_(stoogesAges).max(function (stooge) { return stooge.age; });
result = <_.LoDashExplicitWrapper<IStoogesAge>>_(stoogesAges).max('age');
...
result = <_.LoDashExplicitWrapper<number>>_([4, 2, 8, 6]).min();
result = <_.LoDashExplicitWrapper<IStoogesAge>>_(stoogesAges).min(function (stooge) { return stooge.age; });
result = <_.LoDashExplicitWrapper<IStoogesAge>>_(stoogesAges).min('age');
...
result = <_.LoDashImplicitObjectWrapper<Function>>_(greet).compose(format);
...
result = <_.LoDashImplicitObjectWrapper<Function>>_(function (a: any, b: any, c: any) {
    console.log(a + b + c);
}).curry();
...
result = <_.LoDashExplicitWrapper<number>>_(function () { console.log('deferred'); }).defer();

var log = _.bind(console.log, console);
result = <number>_.delay(log, 1000, 'logged later');
result = <_.LoDashExplicitWrapper<number>>_(log).delay(1000, 'logged later');
