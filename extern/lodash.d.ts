...
// Definitions by: Brian Zengel <https://github.com/bczengel> (modified for ScreepsEngine)
...
declare module _ {
    interface LoDashStatic {
        ...
        (value: string): LoDashImplicitWrapper<string>;
    ...
    interface LoDashArrayWrapperBase<T, TWrapper> {
        /**
         * Produces the toString result of the wrapped value.
         * @return Returns the string result.
         **/
    ...
    interface LoDashObjectWrapperBase<T, TWrapper> {
        /**
         * Produces the toString result of the wrapped value.
         * @return Returns the string result.
         **/
    ...
    interface LoDashImplicitWrapper<T> extends LoDashImplicitWrapperBase<T, LoDashImplicitWrapper<T>>, LoDashWrapperBase<T, LoDashImplicitWrapper<T>> {

    }

    interface LoDashImplicitArrayWrapper<T> extends LoDashImplicitWrapperBase<T, LoDashImplicitArrayWrapper<T>>, LoDashArrayWrapperBase<T, LoDashImplicitArrayWrapper<T>> {
        concat(...items: T[]): LoDashImplicitArrayWrapper<T>;
        ...
        unshift(...items: any[]): LoDashImplicitArrayWrapper<number>;
    }

    interface LoDashImplicitObjectWrapper<T> extends LoDashImplicitWrapperBase<T, LoDashImplicitObjectWrapper<T>>, LoDashObjectWrapperBase<T, LoDashImplicitObjectWrapper<T>> {

    }

    interface LoDashExplicitWrapper<T> extends LoDashExplicitWrapperBase<T, LoDashExplicitWrapper<T>>, LoDashWrapperBase<T, LoDashExplicitWrapper<T>> {
    }

    interface LoDashExplicitArrayWrapper<T> extends LoDashExplicitWrapperBase<T[], LoDashExplicitArrayWrapper<T>>, LoDashArrayWrapperBase<T, LoDashExplicitArrayWrapper<T>> {
        concat(...items: T[]): LoDashExplicitArrayWrapper<T>;
        join(seperator?: string): LoDashExplicitWrapper<string>;
        ...
        unshift(...items: any[]): LoDashExplicitArrayWrapper<number>;
    }

    interface LoDashExplicitObjectWrapper<T> extends LoDashExplicitWrapperBase<T, LoDashExplicitObjectWrapper<T>>, LoDashObjectWrapperBase<T, LoDashExplicitObjectWrapper<T>> {
    ...
    interface LoDashStatic {
        ...
        chain<T>(value: Array<T>): LoDashExplicitArrayWrapper<T>;
    ...
    interface LoDashImplicitArrayWrapper<T> {
         ...
         **/
        difference(
            ...others: Array<T>[]): LoDashImplicitArrayWrapper<T>;
        /**
         * @see _.difference
         **/
        difference(
            ...others: List<T>[]): LoDashImplicitArrayWrapper<T>;
    }
    ...
    interface LoDashExplicitArrayWrapper<T> {
         ...
         **/
        difference(
            ...others: Array<T>[]): LoDashExplicitArrayWrapper<T>;
        /**
         * @see _.difference
         **/
        difference(
            ...others: List<T>[]): LoDashExplicitArrayWrapper<T>;
    }
    ...
    interface LoDashExplicitArrayWrapper<T> {
         ...
         **/
        findIndex(
            pluckValue: string): LoDashExplicitWrapper<number>;

        /**
         * @see _.findIndex
         **/
        findIndex(
            whereDictionary: Dictionary<any>): LoDashExplicitWrapper<number>;
    }
    ...
    interface LoDashImplicitArrayWrapper<T> {
         ...
         * @param n The number of elements to return.
         **/
        first(n: number): LoDashImplicitArrayWrapper<T>;
         ...
         * @param pluckValue "_.pluck" style callback value
         **/
        first(pluckValue: string): LoDashImplicitArrayWrapper<T>;

        /**
         * @see _.first
         * @param whereValue "_.where" style callback value
         **/
        first<W>(whereValue: W): LoDashImplicitArrayWrapper<T>;
         ...
         * @param n The number of elements to return.
         **/
        head(n: number): LoDashImplicitArrayWrapper<T>;
         ...
         * @param pluckValue "_.pluck" style callback value
         **/
        head(pluckValue: string): LoDashImplicitArrayWrapper<T>;

        /**
         * @see _.first
         * @param whereValue "_.where" style callback value
         **/
        head<W>(whereValue: W): LoDashImplicitArrayWrapper<T>;
         ...
         * @param pluckValue "_.pluck" style callback value
         **/
        take(pluckValue: string): LoDashImplicitArrayWrapper<T>;

        /**
         * @see _.first
         * @param whereValue "_.where" style callback value
         **/
        take<W>(whereValue: W): LoDashImplicitArrayWrapper<T>;
    }
    ...
    interface LoDashExplicitArrayWrapper<T> {
         ...
         * @param n The number of elements to return.
         **/
        first(n: number): LoDashExplicitArrayWrapper<T>;
         ...
         * @param pluckValue "_.pluck" style callback value
         **/
        first(pluckValue: string): LoDashExplicitArrayWrapper<T>;

        /**
         * @see _.first
         * @param whereValue "_.where" style callback value
         **/
        first<W>(whereValue: W): LoDashExplicitArrayWrapper<T>;
         ...
         * @param n The number of elements to return.
         **/
        head(n: number): LoDashExplicitArrayWrapper<T>;
         ...
         * @param pluckValue "_.pluck" style callback value
         **/
        head(pluckValue: string): LoDashExplicitArrayWrapper<T>;

        /**
         * @see _.first
         * @param whereValue "_.where" style callback value
         **/
        head<W>(whereValue: W): LoDashExplicitArrayWrapper<T>;

        /**
         * @see _.first
         **/
        take(): LoDashExplicitWrapper<T>;
         ...
         * @param pluckValue "_.pluck" style callback value
         **/
        take(pluckValue: string): LoDashExplicitArrayWrapper<T>;

        /**
         * @see _.first
         * @param whereValue "_.where" style callback value
         **/
        take<W>(whereValue: W): LoDashExplicitArrayWrapper<T>;
    }
    ...
    interface LoDashImplicitArrayWrapper<T> {
         ...
         * @see _.flatten
         **/
        flatten<Flat>(isShallow?: boolean): LoDashImplicitArrayWrapper<Flat>;
        ...
        flatten<Flat>(
            ...
            thisArg?: any): LoDashImplicitArrayWrapper<Flat>;
        ...
        flatten<Flat>(
            isShallow: boolean,
            pluckValue: string): LoDashImplicitArrayWrapper<Flat>;
        ...
        flatten<Flat, W>(
            isShallow: boolean,
            whereValue: W): LoDashImplicitArrayWrapper<Flat>;
    ...
    interface LoDashExplicitArrayWrapper<T> {
         ...
         * @see _.flatten
         **/
        flatten<Flat>(isShallow?: boolean): LoDashExplicitArrayWrapper<Flat>;
        ...
        flatten<Flat>(
            isShallow: boolean,
            callback: ListIterator<T, Flat>,
            thisArg?: any): LoDashExplicitArrayWrapper<Flat>;
        ...
        flatten<Flat>(
            isShallow: boolean,
            pluckValue: string): LoDashExplicitArrayWrapper<Flat>;
        ...
        flatten<Flat, W>(
            isShallow: boolean,
            whereValue: W): LoDashExplicitArrayWrapper<Flat>;
    ...
    interface LoDashExplicitArrayWrapper<T> {
         ...
         **/
        indexOf(
            value: T): LoDashExplicitWrapper<number>;
        ...
        indexOf(
            value: T,
            isSorted: boolean): LoDashExplicitWrapper<number>;
    }
    ...
    interface LoDashArrayWrapperBase<T, TWrapper> {
         ...
         **/
        initial(
            callback: ListIterator<T, boolean>): TWrapper;
    ...
    interface LoDashArrayWrapperBase<T, TWrapper> {
         ...
         * @see _.intersection
         **/
        intersection(...arrays: Array<T>[]): TWrapper;

        /**
         * @see _.intersection
         **/
        intersection(...arrays: List<T>[]): TWrapper;
    }
    ...
    interface LoDashExplicitArrayWrapper<T> {
         ...
         **/
        last(
            pluckValue: string): LoDashExplicitArrayWrapper<T>;
         ...
         **/
        last<W>(
            whereValue: W): LoDashExplicitArrayWrapper<T>;
    }
    ...
    interface LoDashArrayWrapperBase<T, TWrapper> {
         ...
         **/
        remove(
            wherealue?: Dictionary<any>): TWrapper;
    }
    ...
    interface LoDashExplicitArrayWrapper<T> {
        ...
        sortedIndex<W>(
            value: T,
            whereValue: W): LoDashExplicitWrapper<number>;
    }
    ...
    interface LoDashArrayWrapperBase<T, TWrapper> {
         ...
         * @see _.union
         **/
        union(...arrays: Array<T>[]): TWrapper;

        /**
         * @see _.union
         **/
        union(...arrays: List<T>[]): TWrapper;
    }
    ...
    interface LoDashArrayWrapperBase<T, TWrapper> {
         ...
         * @see _.uniq
         **/
        uniq<TSort>(isSorted?: boolean): TWrapper;
         ...
         * @see _.uniq
         **/
        unique(isSorted?: boolean): TWrapper;
    ...
    interface LoDashArrayWrapperBase<T, TWrapper> {
         ...
         **/
        xor(
            ...others: Array<T>[]): TWrapper;
        /**
         * @see _.xor
         **/
        xor(
            ...others: List<T>[]): TWrapper;
    }
    ...
    interface LoDashImplicitArrayWrapper<T> {
         ...
         * @see _.zip
         **/
        zip(...arrays: any[][]): LoDashImplicitArrayWrapper<any[][]>;

        /**
         * @see _.zip
         **/
        unzip(...arrays: any[]): LoDashImplicitArrayWrapper<any[][]>;
    }
    ...
    interface LoDashExplicitArrayWrapper<T> {
         ...
         * @see _.zip
         **/
        zip(...arrays: any[][]): LoDashExplicitArrayWrapper<any[][]>;

        /**
         * @see _.zip
         **/
        unzip(...arrays: any[]): LoDashExplicitArrayWrapper<any[][]>;
    }
    ...
    interface LoDashExplicitArrayWrapper<T> {
        ...
        find(
            callback: ListIterator<T, boolean>,
            thisArg?: any): LoDashExplicitWrapper<T>;
        /**
         * @see _.find
         * @param _.where style callback
         */
        find<W>(
            whereValue: W): LoDashExplicitWrapper<T>;
         ...
         */
        find(
            pluckValue: string): LoDashExplicitWrapper<T>;
    }
    ...
    interface LoDashImplicitArrayWrapper<T>  {
        ...
        groupBy(
            callback: ListIterator<T, any>,
            thisArg?: any): LoDashImplicitObjectWrapper<_.Dictionary<T[]>>;

        /**
         * @see _.groupBy
         **/
        groupBy(
            pluckValue: string): LoDashImplicitObjectWrapper<_.Dictionary<T[]>>;

        /**
         * @see _.groupBy
         **/
        groupBy<W>(
            whereValue: W): LoDashImplicitObjectWrapper<_.Dictionary<T[]>>;
    }
    ...
    interface LoDashExplicitArrayWrapper<T>  {
        ...
        groupBy(
            callback: ListIterator<T, any>,
            thisArg?: any): LoDashExplicitObjectWrapper<_.Dictionary<T[]>>;

        /**
         * @see _.groupBy
         **/
        groupBy(
            pluckValue: string): LoDashExplicitObjectWrapper<_.Dictionary<T[]>>;

        /**
         * @see _.groupBy
         **/
        groupBy<W>(
            whereValue: W): LoDashExplicitObjectWrapper<_.Dictionary<T[]>>;
    }
    ...
    interface LoDashImplicitObjectWrapper<T> {
        ...
        groupBy<TValue>(
            ...
            thisArg?: any): LoDashImplicitObjectWrapper<_.Dictionary<TValue[]>>;

        /**
         * @see _.groupBy
         **/
        groupBy<TValue>(
            pluckValue: string): LoDashImplicitObjectWrapper<_.Dictionary<TValue[]>>;

        /**
         * @see _.groupBy
         **/
        groupBy<W, TValue>(
            whereValue: W): LoDashImplicitObjectWrapper<_.Dictionary<TValue[]>>;
    }
    ...
    interface LoDashExplicitObjectWrapper<T> {
        ...
        groupBy<TValue>(
            callback: ListIterator<TValue, any>,
            thisArg?: any): LoDashExplicitObjectWrapper<_.Dictionary<TValue[]>>;

        /**
         * @see _.groupBy
         **/
        groupBy<TValue>(
            pluckValue: string): LoDashExplicitObjectWrapper<_.Dictionary<TValue[]>>;

        /**
         * @see _.groupBy
         **/
        groupBy<W, TValue>(
            whereValue: W): LoDashExplicitObjectWrapper<_.Dictionary<TValue[]>>;
    }
    ...
    interface LoDashImplicitArrayWrapper<T> {
        ...
        indexBy(
            iterator: ListIterator<T, any>,
            context?: any): LoDashImplicitObjectWrapper<_.Dictionary<T>>;
    ...
    interface LoDashExplicitArrayWrapper<T> {
        ...
        indexBy(
            iterator: ListIterator<T, any>,
            context?: any): LoDashExplicitObjectWrapper<_.Dictionary<T>>;
    ...
    interface LoDashExplicitArrayWrapper<T> {
         ...
         **/
        map<TResult>(
            pluckValue: string): LoDashExplicitArrayWrapper<TResult>;
    ...
    interface LoDashImplicitArrayWrapper<T> {
        ...
        max(
            callback?: ListIterator<T, any>,
            thisArg?: any): LoDashImplicitWrapper<T>;
         ...
         **/
        max(
            pluckValue: string): LoDashImplicitWrapper<T>;
         ...
         **/
        max<W>(
            whereValue: W): LoDashImplicitWrapper<T>;
    }
    ...
    interface LoDashExplicitArrayWrapper<T> {
         ...
         **/
        pluck<TResult>(
            property: string): LoDashExplicitArrayWrapper<TResult>;
    }
    ...
    interface LoDashArrayWrapperBase<T, TWrapper> {
         ...
         * @param pluckValue _.pluck style callback
         **/
        reject(pluckValue: string): TWrapper;

        /**
         * @see _.reject
         * @param whereValue _.where style callback
         **/
        reject<W>(whereValue: W): TWrapper;
    }
    ...
    interface LoDashExplicitObjectWrapper<T> {
         ...
         * @param pluckValue _.pluck style callback
         **/
        reject(pluckValue: string): LoDashExplicitArrayWrapper<T>;

        /**
         * @see _.reject
         * @param whereValue _.where style callback
         **/
        reject<W>(whereValue: W): LoDashExplicitArrayWrapper<T>;
    }
    ...
    interface LoDashArrayWrapperBase<T, TWrapper> {
         ...
         * @param pluckValue _.pluck style callback
         **/
        sortBy(pluckValue: string): TWrapper;

        /**
         * @see _.sortBy
         * @param whereValue _.where style callback
         **/
        sortBy<W>(whereValue: W): TWrapper;
    }

    interface LoDashImplicitObjectWrapperBase<T> {
        /**
         * @see _.sortBy
         **/
        sortBy<TSort>(
    ...
    interface LoDashExplicitArrayWrapper<T> {
         ...
         * @param pluckValue _.pluck style callback
         **/
        sortBy(pluckValue: string): LoDashExplicitArrayWrapper<T>;
    ...
    interface LoDashImplicitObjectWrapper<T> {
         ...
         * @see _.toArray
         **/
        toArray<TValue>(): LoDashImplicitArrayWrapper<TValue>;
    }
    ...
    interface LoDashExplicitObjectWrapper<T> {
         ...
         * @see _.toArray
         **/
        toArray<TValue>(): LoDashExplicitArrayWrapper<TValue>;
    }
    ...
    interface LoDashArrayWrapperBase<T, TWrapper> {
         ...
         * @see _.where
         **/
        where<T, U extends {}>(properties: U): TWrapper;
    }
    ...
    interface LoDashImplicitObjectWrapper<T> {
         ...
         * @see _.where
         **/
        where<T, U extends {}>(properties: U): LoDashImplicitArrayWrapper<T>;
    }
    ...
    interface LoDashExplicitObjectWrapper<T> {
         ...
         * @see _.where
         **/
        where<T, U extends {}>(properties: U): LoDashExplicitArrayWrapper<T>;
    }
    ...
    interface LoDashImplicitObjectWrapper<T> {
        ...
        bind(
            thisArg: any,
            ...args: any[]): LoDashImplicitObjectWrapper<() => any>;
    }
    ...
    interface LoDashImplicitObjectWrapper<T> {
         ...
         * @see _.bindAll
         **/
        bindAll(...methodNames: string[]): LoDashImplicitObjectWrapper<T>;
    }
    ...
    interface LoDashImplicitObjectWrapper<T> {
         ...
         * @see _.compose
         **/
        compose(...funcs: Function[]): LoDashImplicitObjectWrapper<Function>;
    }
    ...
    interface LoDashImplicitObjectWrapper<T> {
         ...
         * @see _.curry
         **/
        curry(arity?: number): LoDashImplicitObjectWrapper<Function>;
    }
